            ...
            <div class="row">
                ...
                <div class="col-md-8" id="bordarDiv">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                                <form id="formulario" enctype="multipart/form-data" action="index.php?p=cadastrar" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"  class="documentos" maxlength="18" name="cpf" class="form-control" id="cpf" placeholder="CPF" ><br/>
                                        <input type="text"  class="documentos" maxlength="10" name="rg" class="form-control" id="rg" placeholder="RG">
                                      </div>
                                      <div class="form-group">
                                            <label >Contatos::</label><br/>
                                            <input type="text"  class="documentos" maxlength="11" name="cel" class="form-control" id="cel" placeholder="Fone" ><br/>
                                            <input type="text"  class="documentos" maxlength="11" name="celWhats" class="form-control" id="celWhats" placeholder="Fone Whatsap">
                                          </div>
                                    <div class="form-group" >
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text"  maxlength="100" name="uf" class="form-control" id="uf" placeholder="Uf">
                                        <input type="text"  maxlength="100" name="cep" class="form-control" id="cep" placeholder="Cep">
                        ...
                        <div class="col-lg-4" id="visualizaFoto">
                                <div id="visualizar">
